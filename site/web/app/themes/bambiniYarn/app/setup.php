...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
    ...
    ?>
    <a class="cart-info cart-customlocation" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'woothemes'); ?>"><i class="icons8-shopping-cart"></i>
            <span class="cart-items"><?php echo sprintf ( _n( '%d', '%d', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ); ?> </span></a>
    <?php
